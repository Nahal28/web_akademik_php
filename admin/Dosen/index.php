                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form name="input" method="post" action="dosen/dosen_update.php">
                                ...
                                <input type="text" id="fid" name="id" value="<?php echo $row['ID_Dosen']?>" maxlength="7" require>
                                <label for="fnama">Nama</label>
                                <input type="text" id="fnama" name="nama" value="<?php echo $row ['Nama_Dosen']?>" require>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form name="input" method="post" action="dosen/dosen_input.php">
                <label for="fid">ID Dosen</label>
                <input type="text" id="fid" name="id" placeholder="ID Dosen" maxlength="7" require>
                <label for="fnama">Nama</label>
                <input type="text" id="fnama" name="nama" placeholder="Nama" require>
                <input type="submit">
            </form>
        </div>
    </div>
