                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form name="input" method="post" action="matkul/matkul_update.php">
                                ...
                                <input type="text" id="fnama" name="nama" value="<?php echo $row['ID_Matkul']?>" required>
                                <label for="fsks">SKS</label>
                                <input type="number" id="fsks" name="sks" value="<?php echo $row['SKS_Matkul']?>" required min=1 max=4>
                                <label for="fnama">Semester</label>
                                <input type="number" id="fsemester" name="semester" value="<?php echo $row['SKS_Matkul']?>" required min=1>
