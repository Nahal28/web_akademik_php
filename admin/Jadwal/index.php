                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form name="input" method="post" action="jadwal/jadwal_mengajar_update.php">
                                ...
                                <input type="text" id="fid" value="<?php echo $row['ID_Dosen']?>" maxlength="7" require>

                                <label for="fnama">Nama Mata Kuliah</label>
                                <input type="text" id="fnama" value="<?php echo $row['ID_Ruangan']?>" require>

                                <label for="fnama">Hari</label>
                                <input type="text" id="fnama" value="<?php echo $row['Hari']?>" require>
                                <datalist id="hari">
                                ...
                                <label for="fdosen">Ruangan <input list="ruangan" name="ruangan" type="text" value="<?php echo $row['ID_Ruanga']?>"></label>
                                <datalist id="ruangan">
                                    <?php 
                                ...
                                <br>
                                <input type="time" name="j_masuk" step="1" value="<?php echo $row_r['Jam_Masuk']?>">
                                <input type="time" name="j_keluar" step="1" value="<?php echo $row_r['Jam_Keluar']?>">
